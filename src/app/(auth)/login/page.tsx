...
const Login: FC = (): ReactElement => {
  const { onLoginSubmit, loading, validationErrors, setValidationErrors } =
    useLogin();
  const {
    ...
    <div className="relative flex flex-col h-screen mx-auto w-11/12 max-w-md rounded-lg bg-white md:w-2/3">
      ...
      <form action={onLoginSubmit}>
        <div className="mt-12 w-full px-5">
          <div className="mb-5 flex flex-col justify-between text-gray-600">
            ...
            <h5
              className="flex w-full text-blue-400 text-center justify-center
            font-normal cursor-pointer hover:underline mb-2"
            >
      ...
      <div className="px-5">
        ...
        <Button
          ...
          className="text-md w-full cursor-pointer rounded px-8 py-2 text-center font-bold
         text-white inline-flex items-center justify-center bg-[#4285F4]
          hover:bg-[#4285F4]/90 focus:outline-none"
        ...
        <Button
          ...
          className="text-md w-full mt-4 cursor-pointer rounded px-8 py-2 text-center font-bold text-white
          inline-flex items-center justify-center bg-[#3b5998] hover:bg-[#3b5998]/90 focus:outline-none"
