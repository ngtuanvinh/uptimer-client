...
const ContactGroupView: FC = (): ReactElement => {
  const { deleteGroup, notifications } = useViewContact();
  return (
    <div className="m-auto px-6 h-screen relative min-h-screen xl:container md:px-12 lg:px-6">
      <div className="h-20 flex items-center justify-end">
        <Link
          href="/contact/create"
          className="mr-1 inline-flex px-4 py-2 text-base font-medium text-white rounded bg-green-400 md:items-center"
        >
