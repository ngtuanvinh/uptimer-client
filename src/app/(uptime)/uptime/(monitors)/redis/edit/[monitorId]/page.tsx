...
import Assertions from "@/app/(uptime)/components/Asssertion";
        ...
        >
          ...
          <div className="p-6 m-auto mt-4 border w-[80%] bg-lightGray">
            <MonitorBaseInfo
              ...
              type="redis"
              urlPlaceholder="redis://username:password@host:port"
            ...
            <Assertions>
              <div className="mb-4">
                <div className="block mb-2 text-medium font-medium text-gray-900">
          ...
          <FormButtons href="/status" buttonLabel="Updata Monitor" />
        </form>
      )}
    </>
  );
